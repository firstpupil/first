...
import sys
import os
from ..firstctrl import __version__, __major__, __minor__, __micro__
import time

package_name = u'firstctrl'
package_name_cap = u'Firstctrl'
description = u'Pupil remapping control software'
